import time
from breeze.utils.appointment_utils import handle_appointment_action, show_upcoming_appointments
from breeze.utils.cli_utils import check_exit, clear_screen_and_show_banner, print_system_message
